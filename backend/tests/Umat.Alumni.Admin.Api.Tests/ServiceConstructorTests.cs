...
public class ServiceConstructorTests
{
    ...
    public void CanConstructAllServiceImplementations()
    {
        ...
        var ___ = new CampaignService(campaignRepo.Object, contributionRepo.Object, memberRepo.Object, storageService.Object, new NullLogger<CampaignService>());
        var ____ = new EventService(eventRepo.Object, eventRsvpRepo.Object, memberRepo.Object, storageService.Object, new NullLogger<EventService>());
        var _____ = new ForumService(forumCategoryRepo.Object, forumThreadRepo.Object, new NullLogger<ForumService>());
        var ______ = new JobService(jobRepo.Object, storageService.Object, new NullLogger<JobService>());
