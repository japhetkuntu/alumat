...
public static class EntityDtoExtensions
{
    ...
    public static DirectoryMemberDto ToDto(this Member m) => new()
    {
        ...
        LastName = m.LastName,
        Email = m.ShowEmailOnDirectory ? m.Email : null,
        Phone = m.ShowPhoneOnDirectory ? m.Phone : null,
        GraduationYear = m.GraduationYear,
        DepartmentId = m.DepartmentId,
        Company = m.ShowCompanyOnDirectory ? m.Company : null,
        JobTitle = m.ShowCompanyOnDirectory ? m.JobTitle : null,
        Location = m.Location,
        LinkedInUrl = m.LinkedInUrl,
        Bio = m.ShowBioOnDirectory ? m.Bio : null,
