...
namespace ReservEase.Alumni.PostgresDb.Sdk.Factories;
...
public class AlumniDbContextFactory : IDesignTimeDbContextFactory<AlumniDbContext>
{
    public AlumniDbContext CreateDbContext(string[] args)
    {
        ...
        // Design-time only — never actually queried during migration scaffolding.
        return new AlumniDbContext(optionsBuilder.Options, new CurrentTenantService());
    }
}
