...
public static class InstitutionFeatures
{
    ...
    [
        ...
        (Directory, "Directory", "Searchable member directory."),
        (AlumniMap, "Member map", "Opt-in world map plotting members by location."),
        ...
        (Services, "Services", "SuperAdmins define paid services (transcripts, attestation letters, certificate reissue, etc.) with a custom request form and fulfillment pipeline; members request and pay online, same platform-fee model as Contributions."),
