...
export function PushNotificationPrompt() {
  ...
  return (
    <div className="mb-4 flex items-start gap-3 rounded-xl border border-border/40 bg-muted/30 px-4 py-3">
      <Bell size={16} className="mt-0.5 shrink-0 text-primary" />
      <div className="min-w-0 flex-1">
        <p className="text-[13px] font-semibold text-foreground">Get notified about new jobs and events</p>
