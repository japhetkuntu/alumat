...
import { Star, CheckCircle, XCircle, Plus, Search, Loader2 } from "lucide-react";import { Pagination } from "@alumni/ui";
  ...
  return (
    <div className="p-[26px] max-w-[1240px] mx-auto space-y-5">
      <header className="flex items-end justify-between gap-4">
        <div>
          <h1 className="text-[25px] font-bold m-0">Alumni spotlights</h1>
